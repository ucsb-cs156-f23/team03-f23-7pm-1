                ...
                <Col>
                    ...
                    <Form.Group className="mb-3" >
                        ...
                        <Form.Control.Feedback type="invalid">
                            ...
                            {errors.requesterEmail?.type === 'pattern' && 'Requester email must be in the correct format.'}
                        </Form.Control.Feedback>
                    </Form.Group>
                </Col>
            </Row>
                ...
                <Col>
                    ...
                    <Form.Group className="mb-3" >
                        ...
                        <Form.Control.Feedback type="invalid">
                            ...
                            {errors.professorEmail?.type === 'pattern' && 'Professor email must be in the correct format.'}
                        </Form.Control.Feedback>
                    </Form.Group>
                </Col>
            </Row>
