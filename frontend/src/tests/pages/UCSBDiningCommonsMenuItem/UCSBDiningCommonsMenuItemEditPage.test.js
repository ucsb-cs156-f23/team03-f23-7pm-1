...
describe("UCSBDiningCommonsMenuItemEditPage tests", () => {
    ...
    describe("tests where backend is working normally", () => {
        ...
        test("Changes when you click Update", async () => {
            ...
            fireEvent.change(nameField, { target: { value: 'Beef Stir Fry' } })
            ...
            expect(mockToast).toBeCalledWith("UCSBDiningCommonsMenuItem Updated - id: 17 name: Beef Stir Fry diningCommonsCode: de-la-guerra station: International");
